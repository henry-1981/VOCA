  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[linear-gradient(180deg,_#f4eee2,_#f8f3ea_42%,_#f1e7d7)] px-4 py-6 text-slate-950 sm:px-6 sm:py-8">
      <div className="mx-auto max-w-4xl">
        <div className="world-panel relative overflow-hidden rounded-[2.25rem] border border-amber-700/20 bg-[linear-gradient(180deg,_rgba(255,252,245,0.95),_rgba(250,246,239,0.98))] p-6 shadow-[0_30px_90px_rgba(96,73,42,0.16)] sm:p-8">
          ...
          <div className="relative flex flex-col gap-6">
            ...
            <section className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_240px]">
              <article className="rounded-[1.8rem] border border-amber-700/20 bg-[linear-gradient(180deg,_#fffdf8,_#fcf7ee)] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
              ...
              <aside className="rounded-[1.8rem] border border-amber-700/20 bg-[#fff8eb] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#9a7a56]">
                  Record Note
                </p>
